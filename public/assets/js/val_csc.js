...
function validateForm()
{
    ...
    if(sanction_Head==='-1')
    {
        ...
        $('#sanction_head').after("<div class=' mt-2 alert alert-danger error'>Please enter the valid Sanction Head</div>");
    }
    else
    {
        $('#sanction_head').next(".error").remove();
    ...
    if(agency==='-1')
    {
        ...
        $('#agency').after("<div class=' mt-2 alert alert-danger error'>Please select Executing Agency</div>");
    }
    else
    {
        $('#agency').next(".error").remove();
