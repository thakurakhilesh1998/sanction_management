...
<div class="card m-4">
    ...
    <div class="card-header">
        <div id="progressData" 
            ...
            data-update-url="{{ url('xen/change-progress-csc/'.$progress->id) }}">
        </div>
        <h4>Update Sanction Progress- CSC Sanctions</h4>
        @if(session('message'))
                        ...
                        <tr>
                            ...
                            @if($images && $images->count() > 0 && $images->work_started_image)
                                <td> 
                                    ...
                                    data-url="{{ url('xen/update-progress-image-csc/'.$progress->id) }}">
                                    Update Image
                                    </button>
                                </td>
                            @else
