...
<div class="edit-building-wrapper">
    ...
    <div class="edit-page-header">
        ...
        <p>
            Update the details of the building entered by this
            Gram Panchayat.
        </p>
    ...
    <div class="edit-card">
        ...
        <div class="edit-card-header">
            ...
            <p>
                Update the information carefully before submitting.
            </p>
        ...
        <div class="edit-card-body">
            ...
            <form action="{{ route('gp.assets.update', $asset->id) }}"
                  method="POST"
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control"
                                ...
                                <option value="official"
                                    {{ old('asset_category', $asset->asset_category) == 'official' ? 'selected' : '' }}>
                                ...
                                <option value="community"
                                    {{ old('asset_category', $asset->asset_category) == 'community' ? 'selected' : '' }}>
                                ...
                                <option value="commercial"
                                    {{ old('asset_category', $asset->asset_category) == 'commercial' ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   class="form-control"
                                   name="building_name"
                                   value="{{ old('building_name', $asset->building_name) }}"
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control"
                                ...
                                <option value="gram_panchayat"
                                    {{ old('ownership', $asset->ownership) == 'gram_panchayat' ? 'selected' : '' }}>
                                ...
                                <option value="panchayat_samiti"
                                    {{ old('ownership', $asset->ownership) == 'panchayat_samiti' ? 'selected' : '' }}>
                                ...
                                <option value="zila_parishad"
                                    {{ old('ownership', $asset->ownership) == 'zila_parishad' ? 'selected' : '' }}>
                ...
                <div class="location-box mb-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <span class="text-muted small mb-2">
                            ...
                            You may recapture the location if required.
                            ...
                            <div class="coordinate-card">
                                ...
                                <div id="accuracy_display">
                                    ...
                                    {{ $asset->location_accuracy
                                        ? $asset->location_accuracy . ' metres'
                                        : 'Not available' }}
                    ...
                    <input type="hidden"
                           ...
                           value="{{ old('location_accuracy', $asset->location_accuracy) }}">


                    <input type="hidden"
                           name="location_captured_at"
                           id="location_captured_at"
                           value="{{ old('location_captured_at', optional($asset->location_captured_at)->format('Y-m-d H:i:s')) }}">
                ...
                <div class="current-photo-box mb-4">
                    ...
                    <div class="photo-help">
                        ...
                        Leave this field blank if you want to keep the
                        existing photograph.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    const existingSubCategory =
        "{{ old('asset_sub_category', $asset->asset_sub_category) }}";


    /*
    |--------------------------------------------------------------------------
    | Existing Panchayat Office Status
    |--------------------------------------------------------------------------
    */

    const existingOfficeStatus =
        "{{ old('panchayat_office_status', $asset->panchayat_office_status) }}";
    ...
    */
    ...
    |
    | Owned by GP  -> ownership automatically GP
    | Taken on Rent -> ownership NULL
    |
    | Other buildings:
    | Ownership is visible and mandatory.
    |
    */
    ...
    function handleOwnership()
    {
        ...
        if (
            ...
            if (
                selectedStatus &&
                selectedStatus.value === 'owned_by_gram_panchayat'
            ) {
                ...
                selectedStatus &&
                selectedStatus.value === 'taken_on_rent'
            ) {
    ...
    */
    ...
    loadSubCategories(existingSubCategory);
    ...
    /*
    |--------------------------------------------------------------------------
    | Restore Existing Panchayat Office Status
    |--------------------------------------------------------------------------
    */

    if (
        existingSubCategory === 'panchayat_ghar' &&
        existingOfficeStatus
    ) {
    ...
    /*
    |--------------------------------------------------------------------------
    | Apply Ownership Rule on Initial Load
    |--------------------------------------------------------------------------
    */
