...
<div class="card m-4">
    ...
    <div class="card-body">
        <form action="{{url('dir/sanction-update-csc/'.$sanction->id)}}"  id="sanction" method="POST">
            @csrf
            @method('PUT')
            {{-- Financial Year --}}
            <div class="mb-3">
            ...
            <div class="mb-3" id="gp-block">
                <label for="Block name" class="form-label">Select Gram Panchayat Name</label>
           ...
           <div class="mb-3">
            ...
            <select name="sanction_purpose" id="sanction_purpose" class="form-control">
               ...
               <option value="Construction of CSC" {{$sanction->sanction_purpose=='Construction of CSC'?'selected':''}}>Construction of CSC</option>
            </select>
           </div>
