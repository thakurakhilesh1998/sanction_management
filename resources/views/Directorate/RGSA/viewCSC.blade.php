...
<div class="card m-4">
    ...
    <div class="card-header">
        <h3 class="h3 mb-3 text-gray-800">View Sanction - RGSA CSC
            <a href="{{ url('dir/add-csc') }}" class="btn btn-primary btn-sm float-right">Add Sanction</a>
        </h3>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered text-center" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($s->san_pdf==null)    
                                <a href="{{url('dir/edit-csc'.'/'.$s->id)}}">Edit</a>
                            @else
...
<div class="modal fade" id="uploadsan" tabindex="-1" aria-labelledby="uploadsanLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="uploadForm" action="{{ route('uploadSanctionCSC') }}" method="POST" enctype="multipart/form-data">
                @csrf
