        ...
        <h4 class="red-line p-2">Images of the Work</h4>
            @if($completion==='Work Started' || 'Partial Completion' || 'Work Completed')  
                @if($completion=='Work Started')
                    @if(!empty($sanctionsForGP[0]->progress_csc->images->work_started_image))
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img src="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_started_image)}}" alt="Work Started Image" class="card-img-top img-fluid fixed-size">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Work Started</h5>
                                    <a href="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_started_image)}}" target="_blank">View Work Started Image</a>            
                                </div>
                            </div>
                        </div> 
                    </div>
                ...
                @if($completion=='Partial Completion')
                    @if(!empty($sanctionsForGP[0]->progress_csc->images->work_started_image) && !empty($sanctionsForGP[0]->progress_csc->images->work_partial_image))
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img src="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_started_image)}}" alt="Work Started Image" class="card-img-top img-fluid fixed-size">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img src="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_partial_image)}}" alt="Work Started Image" class="card-img-top img-fluid fixed-size">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Work Partial Completed</h5>
                                    <a href="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_partial_image)}}" target="_blank">View Work Started Image</a>            
                                </div>
                            </div>
                        </div>
                ...
                @if($completion=='Work Completed')
                    @if(!empty($sanctionsForGP[0]->progress_csc->images->work_started_image) && !empty($sanctionsForGP[0]->progress_csc->images->work_partial_image) && !empty($sanctionsForGP[0]->progress_csc->images->work_completed_image))
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    <img src="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_started_image)}}" alt="Work Started Image" class="card-img-top img-fluid fixed-size">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">Work Started</h5>
                                        <a href="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_started_image)}}" target="_blank" class="img-fluid">View Work Started Image</a>            
                                    </div>
                                </div>
                            </div> 
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    <img src="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_completed_image)}}" alt="Work Started Image" class="card-img-top img-fluid fixed-size">
                                    <div class="card-body text-center">
                                        <h5 class="card-title">Work Completed</h5>
                                        <a href="{{asset('uploads/images'.'/'.$sanctionsForGP[0]->progress_csc->images->work_completed_image)}}" target="_blank">View Work Started Image</a>            
                                    </div>
                                </div>
                            </div>
                        </div>
